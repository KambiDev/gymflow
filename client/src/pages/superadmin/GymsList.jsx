  ...
  return (
    <div className="p-4 sm:p-6 max-w-6xl mx-auto space-y-4">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
        <div>
          <h2 className="text-xl font-bold text-slate-900">Gimnasios Registrados</h2>
          <p className="text-sm text-slate-500">Gestión de suscripciones y altas manuales</p>
        </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-xs p-8 text-center text-slate-500">
        <p className="text-sm">Tabla de gimnasios con botón para registrar pago manual del SaaS listo para que DeepSeek lo conecte.</p>
      </div>
    </div>
  );
}
